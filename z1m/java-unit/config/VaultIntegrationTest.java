...
@SpringBootTest(classes = Z1mApplication.class)
public class VaultIntegrationTest {
    ...
    public void testDualDatabaseStorage() {
        ...
        PersonalInfo person = PersonalInfo.builder()
                ...
                .build();
        PersonalInfo savedPerson = personalRepo.save(person);
        ...
        FinancialInfo finance = FinancialInfo.builder()
                ...
                .balance(1000000L)
                .build();
        FinancialInfo savedFinance = financialRepo.save(finance);
        assertThat(savedFinance.getId()).isNotNull();

        // 3. 物理ファイルの存在確認 (MVCCファイル)
        File personalDbFile = new File("db/personal.mv.db");
        File financialDbFile = new File("db/financial.mv.db");

        assertThat(personalDbFile.exists()).isTrue();
        assertThat(financialDbFile.exists()).isTrue();
    ...
    public void testBase64QrStorage() {
        ...
        assertThat(new File("db/personal.mv.db").exists()).isTrue();
